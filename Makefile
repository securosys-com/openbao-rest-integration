...
#Artifactory vars
IMAGE_NAME = openbao-rest-integration:$(VERSION)
ARTIFACTORY_NAME = securosys.jfrog.io/$(INTERNAL_PREFIX)openbao-rest-integration/
ARTIFACT_NAME = OpenBao-Rest-Integration
...
docker-clean-bin:
	docker compose -f docker-builder/docker-compose.yml run hcvault_clean
