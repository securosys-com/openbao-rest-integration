...
func testAgentExitAfterAuth(t *testing.T, viaFlag bool) {
	...
	cluster := vault.NewTestCluster(t, coreConfig, &vault.TestClusterOptions{
		...
		BaseListenAddress: "127.0.0.1:9300",
	})
	cluster.Start()
...
func TestAgent_Template_Basic(t *testing.T) {
	...
	cluster := vault.NewTestCluster(t,
		...
		&vault.TestClusterOptions{
			BaseListenAddress: "127.0.0.1:9300", HandlerFunc: vaulthttp.Handler,
		})
	cluster.Start()
	defer cluster.Cleanup()
...
// 		&vault.TestClusterOptions{
// 			BaseListenAddress: "127.0.0.1:9300", NumCores: 1,
// 			HandlerFunc: vaulthttp.HandlerFunc(
// 				func(properties *vault.HandlerProperties) http.Handler {
// 					h.props = properties
// 					h.t = t
...
// 	serverClient.SetAddress("https://127.0.0.1:9300")
